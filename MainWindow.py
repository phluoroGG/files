...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def game_resize(self, game: RepaintGame, settings: Settings) -> None:
        ...
        self.resize(31 * settings.col_count + 25, 30 * settings.row_count + 200)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 31 * settings.col_count + 152,
                                                             30 * settings.row_count + 152))
        self.gameFieldTableView.setFixedSize(31 * settings.col_count + 4, 30 * settings.row_count + 4)
        self.colorButtonsTableView.setFixedSize(50 * settings.color_count + 4, 50)
    ...
    def set_settings(self):
        ...
        if self._settingsWindow.radioButtonCustom.isChecked():
            self._settings.row_count = int(self._settingsWindow.lineEditHeight.text())
            self._settings.col_count = int(self._settingsWindow.lineEditWidth.text())
